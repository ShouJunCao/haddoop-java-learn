...
public class T_CallHdfsUtils {
    ...
    public void t_createFilePath() throws IOException {
        boolean trueOrfalse = new CallHdfsUtils("hdfs://192.168.126.128:9000").createFilePath("/hello");
    ...
    public void t_existsPath_01() throws IOException {
        boolean reault = new CallHdfsUtils("hdfs://192.168.126.128:9000").existsPath("/hello");
